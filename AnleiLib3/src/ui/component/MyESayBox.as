package ui.component
{
	...
	public class MyESayBox
	{
		...
		public var contenter:MyTextField;
		public var endFn:Function;
		...
		public function MyESayBox():void
		{
		...
		{ 
			...
			*/
			if (content.substr(position, 3) == "<b>")
			{
				...
				//str1=content.substr(position+1,num1-position-1);
				position=num1+1;
				discontent += "<b>";
				
				while(content.substr(position,4)!="</b>")
				{
					discontent+=content.substr(position,1);
					position++;
				}
